...
\begin{axis} [
symbolic x coords={C++, Python, PHP, Ruby, Swift, C, JavaScript, SQL, Java},
xtick={C++, Python, PHP, Ruby, Swift, C, JavaScript, SQL, Java},
...
\item Obrađena je greška za pristupanje nepostojećeg elementa niza (eng.~{\em out of bounds}).
